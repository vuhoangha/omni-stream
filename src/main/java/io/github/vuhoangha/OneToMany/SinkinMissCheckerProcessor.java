...
public class SinkinMissCheckerProcessor implements EventProcessor {
    ...
    private final BiFunction<ZMQ.Socket, CheckMissMsg, Boolean> eventHandler;
    //endregion
    ...
    public SinkinMissCheckerProcessor(
            RingBuffer<CheckMissMsg> ringBuffer,
            SequenceBarrier sequenceBarrier,
            ZContext zContext,
            String zUrl,
            int timeoutSend,
            int timeoutRecv,
            BiFunction<ZMQ.Socket, CheckMissMsg, Boolean> eventHandler) {
